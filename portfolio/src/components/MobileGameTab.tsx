...
export default function MobileGameTab() {
  return (
    <div className="h-full overflow-y-scroll bg-transparent min-h-0 mobile-smooth-scroll">
      <div className="px-5 pt-14" style={{ paddingBottom: 'calc(13rem + env(safe-area-inset-bottom, 0px))' }}>
